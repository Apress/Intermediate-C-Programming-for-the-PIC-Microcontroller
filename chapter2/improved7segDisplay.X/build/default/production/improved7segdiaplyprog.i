...
# 7 "improved7segdiaplyprog.c" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\PICSetup.h" 1 3
void initialise ()
{
PORTA = 0;
PORTB = 0;
...
# 8 "improved7segdiaplyprog.c" 2


unsigned char n,m;
# 24 "improved7segdiaplyprog.c"
...
{
initialise ();
start: while (! PORTAbits.RA0);
while (1)
{
displayPointer = sevenDisplay;
for (m = 0; m <10; m ++ )
{
if (PORTAbits.RA1) goto start;
